...
public class EventsStatementsHistoryRecord extends org.jooq.impl.TableRecordImpl<com.davidm.mykindlenews.generated.jooq.performance_schema.tables.records.EventsStatementsHistoryRecord> {

	private static final long serialVersionUID = 1047597704;
	 ...
	 */
	public void setNestingEventType(com.davidm.mykindlenews.generated.jooq.performance_schema.enums.EventsStatementsHistoryNestingEventType value) {
		setValue(39, value);
	}
	 ...
	 */
	public com.davidm.mykindlenews.generated.jooq.performance_schema.enums.EventsStatementsHistoryNestingEventType getNestingEventType() {
		return (com.davidm.mykindlenews.generated.jooq.performance_schema.enums.EventsStatementsHistoryNestingEventType) getValue(39);
	}
	...
	public EventsStatementsHistoryRecord() {
		super(com.davidm.mykindlenews.generated.jooq.performance_schema.tables.EventsStatementsHistory.EVENTS_STATEMENTS_HISTORY);
	}

	/**
	 * Create a detached, initialised EventsStatementsHistoryRecord
	 */
	public EventsStatementsHistoryRecord(org.jooq.types.ULong threadId, org.jooq.types.ULong eventId, org.jooq.types.ULong endEventId, java.lang.String eventName, java.lang.String source, org.jooq.types.ULong timerStart, org.jooq.types.ULong timerEnd, org.jooq.types.ULong timerWait, org.jooq.types.ULong lockTime, java.lang.String sqlText, java.lang.String digest, java.lang.String digestText, java.lang.String currentSchema, java.lang.String objectType, java.lang.String objectSchema, java.lang.String objectName, org.jooq.types.ULong objectInstanceBegin, java.lang.Integer mysqlErrno, java.lang.String returnedSqlstate, java.lang.String messageText, org.jooq.types.ULong errors, org.jooq.types.ULong warnings, org.jooq.types.ULong rowsAffected, org.jooq.types.ULong rowsSent, org.jooq.types.ULong rowsExamined, org.jooq.types.ULong createdTmpDiskTables, org.jooq.types.ULong createdTmpTables, org.jooq.types.ULong selectFullJoin, org.jooq.types.ULong selectFullRangeJoin, org.jooq.types.ULong selectRange, org.jooq.types.ULong selectRangeCheck, org.jooq.types.ULong selectScan, org.jooq.types.ULong sortMergePasses, org.jooq.types.ULong sortRange, org.jooq.types.ULong sortRows, org.jooq.types.ULong sortScan, org.jooq.types.ULong noIndexUsed, org.jooq.types.ULong noGoodIndexUsed, org.jooq.types.ULong nestingEventId, com.davidm.mykindlenews.generated.jooq.performance_schema.enums.EventsStatementsHistoryNestingEventType nestingEventType) {
		super(com.davidm.mykindlenews.generated.jooq.performance_schema.tables.EventsStatementsHistory.EVENTS_STATEMENTS_HISTORY);
